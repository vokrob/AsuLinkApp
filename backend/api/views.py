    ...
    return Response({
        ...
        'endpoints': {
            ...
            'events': {
                ...
                'reviews': '/api/events/{id}/reviews/',
                'create_from_post': '/api/events/create-from-post/',
                'calendar': '/api/events/calendar/',
            },
            'campus': {
                'buildings': '/api/campus/buildings/',
                'building_detail': '/api/campus/buildings/{id}/',
                'rooms': '/api/campus/rooms/',
                'room_detail': '/api/campus/rooms/{id}/',
                'room_reviews': '/api/campus/rooms/{id}/reviews/',
                'building_stats': '/api/campus/buildings/{id}/statistics/',
                'room_stats': '/api/campus/rooms/{id}/statistics/',
            },
            'test': '/api/test/',
        },
        'documentation': {
